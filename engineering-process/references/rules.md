...
| Close implement ticket | `delivery` **manage** after push; reopen: `human` manage (3a) or `acceptance` manage (single head conflicts, 3e) | planning, implement/review/verify, gate/acceptance tickets |
