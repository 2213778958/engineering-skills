...
12. **MODELS.md.** Fill `docs/agents/MODELS.md` per [models-stub.md](references/models-stub.md) n×m grid. Read the routing table + this harness's sessions **list**. Print the table; ask if the user wants changes.
